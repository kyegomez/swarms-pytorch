...
# class CellularTransformerNetwork(nn.Module):
#     """
#     Cellular Transformer Network
#     ----------------------------
...
#     Overview:
#         This is a cellular neural network that uses a transformer cell
...
#         >>> model = CellularTransformerNetwork(cell_count=5, input_dim=512, nhead=8)
#         >>> output = model(x)
#         >>> print(output)
...
#         nhead,
#     ):
#         super(CellularTransformerNetwork, self).__init__()
