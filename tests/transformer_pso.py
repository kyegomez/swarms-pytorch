...
from swarms_torch.transformer_pso import SimpleTransformer, TransformerParticleSwarmOptimization
...
def test_TransformerParticleSwarmOptimization_initialization():
    ...
    pso = TransformerParticleSwarmOptimization(model_constructor, model_args, device, criterion, data_loader)
